...
def flatten_distribution(x, y, evaluation_limits):
    ...
    This is the inverse operation compared to what ArbitraryDistribution does.  It is
    not wrapped in a class because I foresee always wanting to re-calculate everything
    ...
    # NOPE the transpose should NOT BE HERE.  The problem is that matplotlib's imshow
    # insists on displaying the transpose of the data, meaning every time I have used
    # that function to verify stuff I have been seeing a transposed version of what
    # I am expecting and then compensate by transposing the actual data, even though
    # I shouldn't  This is so unbelievably frustrating, I have wasted so many hours on
    # this crap.  I am not going to remove the transpose here right now because that would
    # break backwards compatibility with some of my scripts.  But this needs to be addressed
...
# =========================================================================================
# Old code that is largely superseded by arbitrary distribution
# =========================================================================================
...
class ImageBasePoints(BasePointDistributionBase):
    ...
    def __init__(self, filename, x_size, y_size=None, **kwargs):
        ...
        raw_image = np.array(imageio.v2.imread(filename, as_gray=True))
