...
def angle_in_interval(angle, start, end, name=None, epsilion=1e-10):
    ...
    [-PI, PI].  It also seems to have problems unless all of its inputs are float64.
    ...
    epsilion : float, optional
        A small number, necessary to avoid rounding errors that could prevent angles 
        very near to end to be incorrectly excluded.
